...
class BoardUnitTest(unittest.TestCase):
    ...
    def test_board_should_return_value_of_field(self):
        ...
        self.assertEquals(self.sut.get_field(1), 'X')
        self.assertEquals(self.sut.get_field(2), ' ')
        self.assertEquals(self.sut.get_field(3), ' ')
        self.assertEquals(self.sut.get_field(4), 'D')
        self.assertEquals(self.sut.get_field(5), 'A')
        self.assertEquals(self.sut.get_field(6), ' ')
        self.assertEquals(self.sut.get_field(7), 'C')
        self.assertEquals(self.sut.get_field(8), ' ')
        self.assertEquals(self.sut.get_field(9), 'O')
